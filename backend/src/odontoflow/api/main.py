...
from odontoflow.api.routers import communication as communication_router
...
from odontoflow.api.routers import website as website_router
...
app.include_router(website_router.public_router)
